...
public class FastMapEventListenerStatelessClientTest {
    ...
    public void setUp() throws Exception {
        ...
        _StringStringMap = Chassis.acquireMap("chronicleMapString?putReturnsNull=true", String.class, BytesStore.class);
        ...
        _StringStringMapClient = clientSession.acquireMap("chronicleMapString", String.class, BytesStore.class);
        clientSession.registerTopicSubscriber("chronicleMapString", String.class, BytesStore.class, _chronicleTestEventListener);
