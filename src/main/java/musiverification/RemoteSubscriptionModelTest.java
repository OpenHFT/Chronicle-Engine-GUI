...
//                new ChronicleMapKeyValueStore(context.basePath(OS.TARGET).entries(20).averageValueSize(10_000), asset));
        ...
        _clientAssetTree = new VanillaAssetTree(13).forRemoteAccess("RemoteSubscriptionModelPerformanceTest.port", WireType.BINARY);
...
//        testChronicleKeyEventSubscriber.onMessage(testKey3); // no event as the key doesn't exist.
     ...
     */
    //todo Doesn't work on server either - probably not meant to work.
    @Test
