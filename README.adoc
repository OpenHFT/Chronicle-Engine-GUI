...
Queue-Replication is required to create data that can produce network traffic, you can run StartEngineWithDummyData, from the chronicle-queue-enterprise project ( Note: chronicle-queue-enterprise is a licensed project, if you wish to purchase a licence please contact sales@chronicle.software) 
