...
because Queue-Replication.jar is requried to run queueue repliaction, give this is not inlcuded in chronicle-engine, there is also a copy of StartEngineWithDummyData, that will produce some dummy network trafic
